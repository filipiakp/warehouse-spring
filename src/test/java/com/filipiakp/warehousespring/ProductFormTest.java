...
public class ProductFormTest {
	...
	@Test
	public void givenProductFormController_whenCorrectDataPOSTed_thenEntityAddedToRepository() throws Exception{
		long before = repository.count();
		//when
		this.mockMvc.perform(post("/saveProduct").contentType(MediaType.APPLICATION_FORM_URLENCODED)
